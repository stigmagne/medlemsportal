    ...
    return (
        <div className="flex flex-col gap-2 w-full sm:w-auto">
            <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-2 py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#FF5B24] hover:bg-[#E04815] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#FF5B24] disabled:opacity-50 transition-colors"
            >
